...
const Part = () => {
  return (
    ...
    >
      ...
      <div className='mt-5'>
        <h1 className='text-xl sm:text-2xl font-bold text-zinc-700'>Awesome mouse pro</h1>
        <p className='text-xs sm:text-sm text-zinc-500'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis maxime.</p>
        ...
        <div className='grid grid-cols-2 gap-2 text-center mt-2'>
          ...
          <Link className='bg-black text-zinc-200 py-2 rounded-md col-span-2' to="/order/something">
            Book Now
          </Link>
        </div>
      </div>

      <div className='w-max px-3 py-2 bg-zinc-600 text-white font-bold text-sm absolute top-2 right-2 rounded-lg'>$100</div>
    </div>
  )
}
